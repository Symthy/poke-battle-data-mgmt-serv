...
type PartyBattleResultRepository struct {
	BaseWriteRepository[schema.PartyBattleResult, parties.PartyBattleResult, identifier.PartyBattleResultId]
...
func NewPartyBattleResultRepository(dbClient orm.IDbClient) *PartyBattleResultRepository {
	return &PartyBattleResultRepository{
		BaseWriteRepository: BaseWriteRepository[schema.PartyBattleResult, parties.PartyBattleResult, identifier.PartyBattleResultId]{
			dbClient:           dbClient,
