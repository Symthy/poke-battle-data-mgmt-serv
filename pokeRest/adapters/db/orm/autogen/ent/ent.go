...
func columnChecker(table string) func(string) error {
	checks := map[string]func(string) bool{
		abilities.Table:             abilities.ValidColumn,
		battleopponentparty.Table:   battleopponentparty.ValidColumn,
		battlerecords.Table:         battlerecords.ValidColumn,
		forms.Table:                 forms.ValidColumn,
		helditems.Table:             helditems.ValidColumn,
		moves.Table:                 moves.ValidColumn,
		party.Table:                 party.ValidColumn,
		partyresultrecord.Table:     partyresultrecord.ValidColumn,
		pokemons.Table:              pokemons.ValidColumn,
		tags.Table:                  tags.ValidColumn,
		trainedpokemondetails.Table: trainedpokemondetails.ValidColumn,
		trainedpokemons.Table:       trainedpokemons.ValidColumn,
		typecompatibility.Table:     typecompatibility.ValidColumn,
